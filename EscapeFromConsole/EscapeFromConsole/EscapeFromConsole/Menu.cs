...
namespace EscapeFromConsole
{
    internal class Menu
    {
        public void MainMenu()
        {
            ...
            bool valid = inputKey is ConsoleKey.D1 or ConsoleKey.D2 or ConsoleKey.D3;
            while (!valid)
            { 
        ...
        private void Quit()
        {
            ...
            bool valid = inputKey is ConsoleKey.J or ConsoleKey.N;
            while (!valid)
            {
        ...
        private void SelectOptions()
        {
            ...
            ConsoleKey inputKey = Console.ReadKey().Key;
            bool valid = inputKey is ConsoleKey.D1 or ConsoleKey.D2;
